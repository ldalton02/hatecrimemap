...
export const ABOUT_DIALOGS = {
    HCM: {
        PARAGRAPH1: "Hate crime is a global and national human rights problem of significant concern. \
              ...
              greater, yet accurate data on the type and frequency of crimes is not available.",
        PARAGRAPH2: "The Hate Crime Map seeks to address this need by providing a crowd-sourced platform that \
              ...
              the data included herein represents only a fraction of the true number. For an accessible data table, please click \"Show Data\" in the menu.",
        EMAIL: "aisc@ucla.edu",
